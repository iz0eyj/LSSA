import { GarageConfig, ClusterStatus, Bucket, AccessKey, ListObjectsResponse, CreateBucketRequest, UpdateBucketRequest, CreateAccessKeyRequest, UpdateAccessKeyRequest, UploadObjectRequest, UploadObjectResponse, DeleteObjectResponse, ApiResponse } from '../types';
